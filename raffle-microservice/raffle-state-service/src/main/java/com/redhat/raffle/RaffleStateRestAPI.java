...
public class RaffleStateRestAPI extends CacheAccessVerticle {
    ...
    private final Logger logger = Logger.getLogger(RaffleStateRestAPI.class.getName());
    ...
    protected void initSuccess(Future<Void> startFuture) {
        ...
        logger.info(String.format("Starting RaffleRestAPI in %s:%d", host, port));
        ...
        router.get("/").handler(rc -> {
            ...
            .end("Welcome to Raffle Service API Service");
        });
